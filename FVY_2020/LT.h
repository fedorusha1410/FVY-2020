...
#define LEX_ELSE		 'r'	// ложный блок
#define LEX_THEN		 'w'	// истинный блок
#define LEX_DO			 'd'	// do
#define LEX_OUTPUT		 'o'	// вывод
#define LEX_OUTLINE		 '^'	// вывод с переводом строки
